...
def _to_response(profile: UserProfile | None, user: User) -> UserProfileResponse:
    return UserProfileResponse(
        ...
        trabajo_profesion=profile.trabajo_profesion if profile else None,
        convivencia=profile.convivencia if profile else None,
        ex_pareja_relevante=profile.ex_pareja_relevante if profile else None,
        ex_pareja_contexto=profile.ex_pareja_contexto if profile else None,
        estructura_familiar_relevante=profile.estructura_familiar_relevante if profile else None,
        hijos_detalle=profile.hijos_detalle if profile else None,

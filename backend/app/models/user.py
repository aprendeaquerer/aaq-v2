...
class UserProfile(Base):
    ...
    trabajo_profesion: Mapped[Optional[str]] = mapped_column(String, nullable=True)
    convivencia: Mapped[Optional[str]] = mapped_column(String, nullable=True)
    ex_pareja_relevante: Mapped[Optional[bool]] = mapped_column(Boolean, nullable=True)
    ex_pareja_contexto: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    estructura_familiar_relevante: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    hijos_detalle: Mapped[Optional[str]] = mapped_column(Text, nullable=True)

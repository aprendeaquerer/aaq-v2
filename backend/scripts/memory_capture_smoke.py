...
SYNTHETIC_USERS = [
    SyntheticUser(
        ...
        messages=[
            ...
            "Mi ex pareja aparece a veces por redes y eso es relevante.",
    ...
    SyntheticUser(
        ...
        messages=[
            ...
            "Tenemos dos hijos de 6 y 9 años y vivimos juntos.",
    ...
    SyntheticUser(
        ...
        messages=[
            ...
            "Trabajo como diseñadora y vivo sola.",
